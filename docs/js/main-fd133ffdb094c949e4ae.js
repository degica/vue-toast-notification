...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,runtime_core_esm_bundler/* openBlock */.wg)(), (0,runtime_core_esm_bundler/* createBlock */.j4)(runtime_dom_esm_bundler/* Transition */.uT, {
    ...
    default: (0,runtime_core_esm_bundler/* withCtx */.w5)(() => [(0,runtime_core_esm_bundler/* withDirectives */.wy)((0,runtime_core_esm_bundler/* createVNode */.Wm)("div", {
      ...
      onMouseover: _cache[2] || (_cache[2] = $event => _ctx.toggleTimer(true)),
      onMouseleave: _cache[3] || (_cache[3] = $event => _ctx.toggleTimer(false)),
      onClick: _cache[4] || (_cache[4] = (...args) => _ctx.whenClicked && _ctx.whenClicked(...args))
    }, [_hoisted_1, (0,runtime_core_esm_bundler/* createVNode */.Wm)("p", {
      class: "v-toast__text",
      innerHTML: _ctx.message
    }, null, 8, ["innerHTML"]), _ctx.dismissible ? ((0,runtime_core_esm_bundler/* openBlock */.wg)(), (0,runtime_core_esm_bundler/* createBlock */.j4)("button", {
      key: 0,
